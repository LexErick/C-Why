# 0 "004_args_memory_arithmetic.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "004_args_memory_arithmetic.c"
...
# 2 "004_args_memory_arithmetic.c" 2


# 3 "004_args_memory_arithmetic.c"
int main (int argc, char **argv){


    printf("\n [--- Program to Print Memory Addresses of Each Argument --- ]\n\n");
# 16 "004_args_memory_arithmetic.c"
